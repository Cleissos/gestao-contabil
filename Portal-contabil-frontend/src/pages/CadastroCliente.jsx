...
export default function CadastroCliente() {
    const [formData, setFormData] = useState({
        nome: '',
        email: '', // 💡 ADICIONADO: Novo estado para o e-mail do cliente
        cpfCnpj: '',
        password: '',
        tipoCliente: 'PF'
    });
    ...
    const handleCadastro = async (e) => {
        e.preventDefault();
        try {
            // Garante que o payload vai com o CPF/CNPJ limpo e inclui o e-mail
            const dadosParaEnviar = {
                ...formData,
            ...
            // 💡 ATUALIZADO: Reseta o formulário limpando também o e-mail
            setFormData({ nome: '', email: '', cpfCnpj: '', password: '', tipoCliente: 'PF' });
        } catch (error) {
            console.error("Erro ao cadastrar cliente:", error);
            alert("Erro ao cadastrar cliente. Verifique os dados. " + (error.response?.data || error.message));
        }
    };
                        ...
                        <Grid container spacing={2}>
                            ...
                            <Grid item xs={12} md={4}>
                                <TextField
                                    ...
                                    label="Tipo"
                                    value={formData.tipoCliente}
                                    onChange={(e) => setFormData({ ...formData, tipoCliente: e.target.value, cpfCnpj: '' })}
                                >
                                    <MenuItem value="PF">Pessoa Física (CPF)</MenuItem>
                                    <MenuItem value="MEI">Pessoa Jurídica (CNPJ)</MenuItem>
                                </TextField>
                            ...
                            {/* 💡 NOVO CAMPO: Entrada de E-mail obrigatória ocupando largura total */}
                            <Grid item xs={12}>
                                <TextField
                                    fullWidth
                                    ...
                                    type="email"
                                    required
                                    helperText="Este e-mail será utilizado pelo cliente para recuperação de senha."
